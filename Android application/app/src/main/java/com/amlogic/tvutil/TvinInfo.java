...
public class TvinInfo implements Parcelable
{
    ...
    public int reserved;
    public static final Parcelable.Creator<TvinInfo> CREATOR;
    
    public void readFromParcel(final Parcel in) {
        this.trans_fmt = tvin_trans_fmt.values()[in.readInt()];
        this.fmt = tvin_sig_fmt_e.values()[in.readInt()];
        this.status = tvin_sig_status_t.values()[in.readInt()];
        this.reserved = in.readInt();
    }
    
    public void writeToParcel(final Parcel dest, final int flag) {
        dest.writeInt(this.trans_fmt.ordinal());
        dest.writeInt(this.fmt.ordinal());
        dest.writeInt(this.status.ordinal());
        dest.writeInt(this.reserved);
    }
    
    public TvinInfo(final Parcel in) {
    ...
    static {
        CREATOR = (Parcelable.Creator)new Parcelable.Creator<TvinInfo>() {
            public TvinInfo createFromParcel(final Parcel in) {
                return new TvinInfo(in);
            }
            
            public TvinInfo[] newArray(final int size) {
    ...
    public enum tvin_sig_fmt_e
    {
        ...
        private tvin_sig_fmt_e(final int val) {
            this.val = val;
        }
        
        public static tvin_sig_fmt_e valueOf(final int value) {
            for (final tvin_sig_fmt_e fmt : values()) {
                if (fmt.toInt() == value) {
                    return fmt;
                }
            }
            return tvin_sig_fmt_e.TVIN_SIG_FMT_MAX;
        }
